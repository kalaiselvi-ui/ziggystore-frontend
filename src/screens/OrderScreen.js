...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "RETURN_REQUEST":
      return { ...state, loadingReturn: true };
    case "RETURN_SUCCESS":
      return { ...state, loadingReturn: false, successReturn: true };
    case "RETURN_FAIL":
      return { ...state, loadingReturn: false };
    case "RETURN_RESET":
      return {
        ...state,
        loadingReturn: false,
            ...
            <Col md={8}>
              ...
              <Card className="mb-3">
                <Card.Body>
                  ...
                  <Card.Text>
                    <strong>Return:</strong> {order.isReturned}
                    {order.isReturned ? (
                      <MessageBox variant="success">
                        Returned at {order.returnedAt}
                      </MessageBox>
                    ) : (
